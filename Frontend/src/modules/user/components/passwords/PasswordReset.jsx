                ...
                <CardContent className="p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-8">
                        <div className="flex flex-col items-center gap-2 text-center">
                            <h2 className="text-2xl font-bold tracking-tight">{t('user:resetYourPassword')}</h2>
                            <p className="text-sm text-muted-foreground max-w-sm">{t('user:resetPasswordDescription')}</p>
                        </div>
