import { generateTempToken, generateToken, validateTempToken } from "#utils/crypto/jwt.js";
...
export class AuthController {
    ...
    constructor({ userService, logService, userPermissionService }){
    ...
    oAuth = async (req, res) => {
        ...
        try {
            const { user, permissions } = await this.userService.oAuth({ provider, token: credential });
    ...
    logout = async (req, res) => {
        try {
            ...
            await this.userService.updateById(user._id, { is2FAVerified: false });
    ...
    forgotPassword = async (req, res) => {
        try {
            ...
            await this.userService.updateById(user._id, { tempToken: tokenHash, tempTokenExpires: expires });
